...
export default function FormPozCreate({ setShow, isProject }) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (!isProject?._id) {
        ...
        console.log("isProject?._id", "yok -- error")
      } else {
  ...
  const SignupSchema = Yup.object().shape({
    ...
    newPozName: Yup.string()
      .min(2, 'Too Short!')
      .max(50, 'Too Long!')
      .required('Required'),

    newPozUnit: Yup.string()
      .required('Required'),
              ...
              <DialogContent>
                ...
                <Box onClick={() => setError_for_name(false)} sx={{ marginBottom: "1.5rem" }}>
                  <TextField
                    ...
                    id="newPozName"
                    name="newPozName"
                    // value={formik.values.newPozName}
                    // onChange={formik.handleChange}
                ...
                <Box onClick={() => setError_for_unit(false)} sx={{ marginBottom: "1.5rem" }}>
                  <TextField
                    ...
                    id="newPozUnit"
                    name="newPozUnit"
                    // value={formik.values.newPozUnit}
                    // onChange={formik.handleChange}
